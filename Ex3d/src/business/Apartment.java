...
//        this.renter = null;
    ...
    public Apartment(int apartmentId, String apartmentNum, int squareFeet, int bathrooms, double price, LocalDateTime updated) {
...
//                "\n";
        return this.apartmentNum + ", " + this.squareFeet +"ft, $" + this.price;
    }
}
